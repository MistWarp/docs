...
:::info
This page is about the [MistWarp Packager](https://packager.warp.mistium.com/). If you just want an easy way to embed a Scratch project into a website, see [the other embedding page](/embedding).
:::
